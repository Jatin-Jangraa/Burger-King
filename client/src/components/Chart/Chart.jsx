...
//       .call(d3.axisBottom(xScale).ticks(data.length).tickFormat(d =>` Day ${d}`));
...
//     // Categorical xScale using month names
...
//     // Line generators using scaleBand midpoint for x
//     const lineRevenue = d3.line()
