...
//     profilePic:`${user?`${user.user.photo}`:"././src/assets/USer_Icon.png"}`,
//     orders: [
//       { id: 1, item: "iPhone 14", status: "Delivered" },
//       { id: 2, item: "AirPods Pro", status: "Shipped" },
//       { id: 3, item: "Samsung Monitor", status: "Processing" },
//        { id: 1, item: "iPhone 14", status: "Delivered" },
//       { id: 2, item: "AirPods Pro", status: "Shipped" },
//       { id: 3, item: "Samsung Monitor", status: "Processing" },
//     ],
...
//       >
//         <img src={userdata.profilePic} alt="Profile" onError={(e)=>{e.target.onError = null; e.target.src ="http://res.cloudinary.com/dhte80xl2/image/upload/v1751449436/ryske7khyuovbrrer6jf.png"}} className="profile-pic" />
...
//             <li key={order.id}>
//               <span>{order.orderitems.map((itm)=>{return <span> {itm.name}</span>})}</span>
